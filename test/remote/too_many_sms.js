  ...
  function (t) {
    ...
    return client.postAsync('/check', { ip: TEST_IP, email: 'test1@example.com', payload: { phoneNumber: PHONE_NUMBER }, action: CONNECT_DEVICE_SMS })
      ...
      .spread(function(req, res, obj){
        ...
        return client.postAsync('/check', { ip: TEST_IP3, email: 'test4@example.com', action: 'anotherAction' })
      })
      .spread(function(req, res, obj){
        t.equal(res.statusCode, 200, 'returns a 200')
        t.equal(obj.block, false, 'not rate limited')
        ...
        return client.postAsync('/check', { ip: TEST_IP4, email: 'test5@example.com', payload: { phoneNumber: PHONE_NUMBER }, action: CONNECT_DEVICE_SMS })
      })
...
test(
  ...
  function (t) {
    ...
    // Send requests until throttled
    return client.postAsync('/check', { ip: TEST_IP4, email: 'test1@example.com', payload: { phoneNumber: '1111111111' }, action: CONNECT_DEVICE_SMS })
      .spread(function(req, res, obj){
        t.equal(res.statusCode, 200, 'returns a 200')
        t.equal(obj.block, false, 'not rate limited')
        return client.postAsync('/check', { ip: TEST_IP4, email: 'test2@example.com', payload: { phoneNumber: '1111111111' }, action: CONNECT_DEVICE_SMS })
      })
      .spread(function(req, res, obj){
        t.equal(res.statusCode, 200, 'returns a 200')
        t.equal(obj.block, false, 'not rate limited')
        return client.postAsync('/check', { ip: TEST_IP4, email: 'test3@example.com', payload: { phoneNumber: '3111111111' }, action: CONNECT_DEVICE_SMS })
      })
      .spread(function(req, res, obj){
        t.equal(res.statusCode, 200, 'returns a 200')
        t.equal(obj.block, true, 'rate limited')
      ...
      // Reissue requests to verify that throttling is disabled
      .then(function(){
        return client.postAsync('/check', { ip: TEST_IP4, email: 'test6@example.com', payload: { phoneNumber: '5111111111' }, action: CONNECT_DEVICE_SMS })
      })
      .spread(function(req, res, obj){
        t.equal(res.statusCode, 200, 'returns a 200')
        t.equal(obj.block, false, 'not rate limited')
...
test(
  '/check `connectDeviceSms` by email',
  function (t) {

    // Send requests until throttled
    return client.postAsync('/check', { ip: TEST_IP, email: 'test1@example.com', payload: { phoneNumber: '1111111111' }, action: CONNECT_DEVICE_SMS })
      .spread(function(req, res, obj){
        t.equal(res.statusCode, 200, 'returns a 200')
        t.equal(obj.block, false, 'not rate limited')
        return client.postAsync('/check', { ip: TEST_IP2, email: 'test1@example.com', payload: { phoneNumber: '1111111112' }, action: CONNECT_DEVICE_SMS })
      })
      .spread(function(req, res, obj){
        t.equal(res.statusCode, 200, 'returns a 200')
        t.equal(obj.block, false, 'not rate limited')
        return client.postAsync('/check', { ip: TEST_IP3, email: 'test1@example.com', payload: { phoneNumber: '1111111113' }, action: CONNECT_DEVICE_SMS })
      })
      .spread(function(req, res, obj){
        t.equal(res.statusCode, 200, 'returns a 200')
        t.equal(obj.block, true, 'rate limited')
        ...
        return client.postAsync('/check', { ip: TEST_IP3, email: 'test1@example.com', action: 'anotherAction' })
      })
      .spread(function(req, res, obj){
        t.equal(res.statusCode, 200, 'returns a 200')
        t.equal(obj.block, false, 'rate limited')
      ...
      // Reissue requests to verify that throttling is disabled
      .then(function(){
        return client.postAsync('/check', { ip: TEST_IP6, email: 'test1@example.com', payload: { phoneNumber: '1111111115' }, action: CONNECT_DEVICE_SMS })
      })
      .spread(function(req, res, obj){
        t.equal(res.statusCode, 200, 'returns a 200')
        t.equal(obj.block, false, 'not rate limited')
